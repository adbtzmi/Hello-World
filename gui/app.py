...
class SimpleGUI:
    ...
    def create_widgets(self):
        # Create PanedWindow to allow dragging left/right bounds
        self.paned_window = ttk.PanedWindow(self.root, orient=tk.HORIZONTAL)
        self.paned_window.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        
        # Left side - Main container with tabs
        main_frame = ttk.Frame(self.paned_window, padding="5")
        ...
        log_frame = ttk.LabelFrame(self.paned_window, text="Progress Log", padding="5")
        self.paned_window.add(log_frame, weight=2)
        
        self.log_text = scrolledtext.ScrolledText(log_frame, height=48, width=45, wrap=tk.WORD)
    ...
    def create_implementation_tab(self):
        ...
        self._tester_registry_file = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "bento_testers.json"
        )
